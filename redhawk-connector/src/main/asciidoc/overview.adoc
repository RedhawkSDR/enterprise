...
* Add a configuration for REDHAWK by dropping a file beginning with this prefix: `redhawk.datasource.factory` and append a unique string (for example, `myConfig.cfg`) file into the `etc` directory of your Karaf install.
