...
public class RedhawkDriverTest {
	...
	public void testConstructorThreeWithOSGI() {
		...
		assertEquals(redhawk.getHostName(), "127.0.0.1");
		assertEquals(redhawk.getPort(), 3333);
		//TODO: Should add some more tests for system props
	...
	public void testToString() {
		...
		assertEquals(driver.toString(), driverString);
	}	

//Below are integration tests that may be useful at some point But can not run in
