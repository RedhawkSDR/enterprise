...
@ServerEndpoint("/{nameServer}/domains/{domainName}/applications/{applicationName}/components/{componentName}/ports/{portName}")
public class ComponentPortEndpoint {

    private static Logger logger = Logger.getLogger(ComponentPortEndpoint.class.getName());
	...
	public void onOpen(Session session, EndpointConfig c, @PathParam("nameServer") String nameServer, @PathParam("domainName") String domainName, 
			@PathParam("applicationName") String applicationName, @PathParam("componentName") String componentName, @PathParam("portName") String portName) {
		  logger.info("Connected ... " + session.getId());
	        ...
	        String portUrl = domainName+"/"+applicationName+"/"+componentName+"/"+portName;
	        RedhawkPort port;
			try {
