...
The `REDHAWKDriver` has abstract classes that provide base functionality for the different event types provided in REDHAWK. Users can extend one of the Helper abstract classes as shown in the following example and would only be responsible for implementing the onMessage function.
