...
export default {
  ...
  computed: {
    availablePortStats(){
      return this.$store.getters.available.PORT
    },
    name(){
      return this.$store.getters.portName
    },
    appName(){
      return this.$store.getters.portApplicationName
    },
    componentName(){
      return this.$store.getters.portComponentName
    },
    statistics(){
