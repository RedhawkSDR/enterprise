...
----
include::snippets/RedhawkDomainManagerImplIT.java[lines=144..148]
----
...
.`RedhawkDomainManagerImplIT.java`
----
include::snippets/RedhawkDomainManagerImplIT.java[lines=153..154]
----
...
.`RedhawkDomainManagerImplIT.java`
----
include::snippets/RedhawkDomainManagerImplIT.java[lines=159..164]
----
...
.`RedhawkDomainManagerImplIT.java`
----
include::snippets/RedhawkDomainManagerImplIT.java[lines=164..170]
----
