 ...
 */
public class MessageProducer extends MessageProducer_base {
    /**
    ...
    protected int serviceFunction() {
        ...
        myMessage_struct message = new myMessage_struct();
        message.text.setValue("Hello World");
        message.timestamp.setValue(System.currentTimeMillis());
        
        this.port_message_out.sendMessage(message);
