...
After installing REDHAWK Java Tools, the following directories are displayed.

* `karaf-<version>`: Directory contains a custom distribution of Karaf prepackaged with all REDHAWK Java Tool assets. 
